#!/usr/bin/env bash
# Run experiment for Config 5 (PubMedBERT + joint uniform weighting).
# Usage: bash scripts/run_config_5.sh [seeds]
# Example: bash scripts/run_config_5.sh "42,1337,2024"
...
for seed in "${SEED_ARRAY[@]}"; do
    echo "=== Running Config 5 (Joint Uniform) with seed=${seed} ==="
